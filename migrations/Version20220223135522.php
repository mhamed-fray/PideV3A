 ...
 */
final class Version20220223135522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE image filename VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C8495596A1805B');
        $this->addSql('DROP INDEX IDX_42C8495596A1805B ON reservation');
        $this->addSql('ALTER TABLE reservation DROP idev_id, DROP nbplaces');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD image VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP filename, CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE localisation localisation VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE reservation ADD idev_id INT NOT NULL, ADD nbplaces INT NOT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495596A1805B FOREIGN KEY (idev_id) REFERENCES evenement (id)');
        $this->addSql('CREATE INDEX IDX_42C8495596A1805B ON reservation (idev_id)');
