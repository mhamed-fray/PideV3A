 ...
 */
final class Version20220302202105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz DROP FOREIGN KEY FK_A412FA92D9144651');
        $this->addSql('DROP INDEX IDX_A412FA92D9144651 ON quiz');
        $this->addSql('ALTER TABLE quiz DROP choix_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE choix CHANGE contenu contenu VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE quiz ADD choix_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE quiz ADD CONSTRAINT FK_A412FA92D9144651 FOREIGN KEY (choix_id) REFERENCES choix (id)');
        $this->addSql('CREATE INDEX IDX_A412FA92D9144651 ON quiz (choix_id)');
