 ...
 */
final class Version20220302195922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_4F488091853CD175 ON choix');
        $this->addSql('ALTER TABLE choix DROP quiz_id');
        $this->addSql('ALTER TABLE quiz CHANGE test_id test_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE choix ADD quiz_id INT DEFAULT NULL, CHANGE contenu contenu VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE choix ADD CONSTRAINT FK_4F488091853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
        $this->addSql('CREATE INDEX IDX_4F488091853CD175 ON choix (quiz_id)');
        ...
        $this->addSql('ALTER TABLE quiz CHANGE test_id test_id INT NOT NULL');
