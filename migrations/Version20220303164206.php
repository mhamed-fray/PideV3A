 ...
 */
final class Version20220303164206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature CHANGE offre_id offre_id INT NOT NULL, CHANGE etat_candidature etat_candidature VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature CHANGE offre_id offre_id INT DEFAULT NULL, CHANGE etat_candidature etat_candidature VARCHAR(255) DEFAULT \'En Attente\' COLLATE `utf8mb4_unicode_ci`, CHANGE message message VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
