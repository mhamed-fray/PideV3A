 ...
 */
final class Version20220222235222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature ADD offre_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE offre CHANGE datee_publication datee_publication VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature DROP offre_id, CHANGE etat_candidature etat_candidature VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE message message VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
