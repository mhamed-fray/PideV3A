 ...
 */
final class Version20220223160703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP filename');
        $this->addSql('ALTER TABLE reservation ADD idev_id INT NOT NULL, ADD nbplace INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP idev_id, DROP nbplace');
