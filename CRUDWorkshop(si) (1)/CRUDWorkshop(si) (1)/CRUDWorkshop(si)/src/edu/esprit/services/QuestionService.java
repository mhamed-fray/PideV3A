...
public class QuestionService {
 ...
 public void ajouterQuestion(Question p,Choix c1,Choix c2,Choix c3){
     ...
     try {
        ...
        if(qu_exist == 1)
        {
            ...
            String query ="insert into question(contenu,test_id) values('"+p.getContenu()+"','"+2+"')";
 ...
 public List<Question> afficherQuestion(int test_id){
        List<Question> personnes = new ArrayList<>();
        String sql ="select * from question where test_id="+test_id;
        try {
 ...
 public int modifierr(Question c,String question_mod){
String sq13="UPDATE `question`SET Contenu=? WHERE contenu='"+question_mod+"'";
